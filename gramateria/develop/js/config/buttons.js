        ...
        const form = `
            ...
            <form id="deploy-form" class="gram-form">
                <div class="form-group">
                    <label>ชื่อเว็บไซต์ <span class="required">*</span></label>
    ...
    command: (editor, sender) => {
        ...
        const form = `
            <form id="export-form" class="gram-form">
                ...
                <div class="form-group">
                    <label>คำอธิบายเว็บไซต์ <span class="required">*</span></label>
                    <textarea name="description" class="form-control">${description || ''}</textarea>
                </div>
                <div class="form-group">
                    <button class="btn btn-primary export-btn"><span class="fa fa-download"></span> ส่งออก</button>
                </div>
            </form>
            `;
        ...
        exportForm.addEventListener('submit', async (e) => {
            ...
            if (!title) {
                noty.error('จำเป็นต้องมีชื่อเว็บไซต์');
                return;
            }
            if (!description) {
                noty.error('จำเป็นต้องมีคำอธิบาย');
                return;
            }
            localStorage.setItem('gram-seo', JSON.stringify(SEO));
